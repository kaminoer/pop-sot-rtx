...
5. Place [`d3d9.dll`](https://github.com/kaminoer/pop-sot-rtx/releases/tag/v0.1) in the game folder (for example `C:\Program Files (x86)\Ubisoft\Ubisoft Game Launcher\games\Prince of Persia Sands of Time`).
