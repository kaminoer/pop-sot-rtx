...
- Some effects may look off (wrong color/no animation/distorted/not like in the original rendering pipeline) or be missing. Report any issues or missing effects.
...
3. Install the [RTX Remix toolkit and unpack the remix runtime to your SoT directory](https://github.com/NVIDIAGameWorks/rtx-remix/releases).
